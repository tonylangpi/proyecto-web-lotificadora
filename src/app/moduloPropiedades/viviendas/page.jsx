          ...
          <Form onSubmit={enviar}>
            ...
            <Row className="mb-3">
              ...
              <Form.Group as={Col} controlId="formGridPropietario">
                ...
                >
                  {data?.propietarios ? (
                    data.propietarios.map((cat, index) => (
                ...
                <div className="d-flex p-2">
                  <Button
                    ...
                    onClick={async () => {
                      if (
                        !confirm(
                          `Deseas eliminar la vivienda con codigo: ${row.getValue(
                            "codigo"
                          )}`
                        )
                      ) {
                      ...
                      let res = await DeleteViviendas(row.getValue("codigo"));
                  ...
                  <Button
                    ...
                    onClick={() => {
                      router.push(
                        `/moduloPropiedades/viviendas/${row.getValue("codigo")}`
                      );
                    }}
                  >
                    <EditIcon />
